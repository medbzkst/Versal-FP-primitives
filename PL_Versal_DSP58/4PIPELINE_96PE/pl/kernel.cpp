...
extern "C"
{
    ...
    {
#pragma HLS INTERFACE m_axi port = A offset = slave bundle = gmem_A depth = 384
#pragma HLS INTERFACE s_axilite port = A bundle = control
#pragma HLS INTERFACE m_axi port = B offset = slave bundle = gmem_B depth = 384
#pragma HLS INTERFACE s_axilite port = B bundle = control
#pragma HLS INTERFACE m_axi port = C offset = slave bundle = gmem_C depth = 384
